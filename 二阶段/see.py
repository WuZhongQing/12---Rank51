...
def design2():
    ...
    x0 = numpy.array([-614, -934, 1073, 715, 186, -923, 833, -63])
    y0 = numpy.array([1059, 715, 291, 129, 432, 632, 187, 363])
    plt.plot(x0, y0, 'b>', label='Ground Base Station', linewidth=2, alpha=1)
